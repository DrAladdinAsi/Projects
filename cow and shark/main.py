...
pygame.display.set_caption('Cows Can\'t Fly!')
...
player_x = 240
player_y = 40
penguin = pygame.transform.scale(pygame.image.load('assets/cow2.png'), (50, 50))
direction = -1
y_speed = 0
gravity = 0.2
x_speed = 3
...
while run:
    ...
    if game_over:
        end_text = huge_font.render('Cows Can\'t Fly!', True, 'black')
